...
<footer class="wrapper-max">
    ...
    <section>
        <section class="footer-content-right">
            <ul>
                <li>
                    <ul>
                        <li>
...
<style lang="scss">
    ...
    .europe-icon svg {
      ...
      width: 2em;
      fill: white;
      animation: spin-europe 48s linear infinite;
    }
    .europe-text {
      color: white;
